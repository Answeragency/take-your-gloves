  ...
  return (
    <motion.div
      ...
      style={{
        ...
        translateY: "-50%",
        background: hovering
          ? "radial-gradient(circle, rgba(35,88,176,0.35) 0%, rgba(35,88,176,0.10) 40%, transparent 70%)"
          : "radial-gradient(circle, rgba(35,88,176,0.18) 0%, rgba(35,88,176,0.05) 40%, transparent 70%)",
      }}
      animate={{
