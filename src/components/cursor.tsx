  ...
  return (
    <motion.div
      ...
      style={{
        ...
        translateY: "-50%",
        background: hovering
          ? "radial-gradient(circle, rgba(184,82,40,0.32) 0%, rgba(184,82,40,0.10) 40%, transparent 70%)"
          : "radial-gradient(circle, rgba(184,82,40,0.18) 0%, rgba(184,82,40,0.06) 40%, transparent 70%)",
      }}
      animate={{
