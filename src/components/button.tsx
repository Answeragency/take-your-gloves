...
const variants = {
  primary:
    "bg-accent text-foreground hover:bg-accent-dim hover:scale-[1.03] hover:shadow-[0_0_32px_rgba(58,92,168,0.55)] active:scale-[0.97]",
  outline:
    "border border-foreground/25 text-foreground hover:border-accent/70 hover:text-accent hover:bg-accent/5 hover:shadow-[0_0_18px_rgba(58,92,168,0.22)] active:scale-[0.97]",
